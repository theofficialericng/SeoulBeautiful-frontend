    ...
    <footer className="bg-gray-100 py-8">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div>
            <h3 className="text-lg font-semibold mb-4">Seoul Beautiful</h3>
            <p className="text-sm text-gray-600">
              Your trusted guide to Korean plastic surgery procedures and clinics.
            </p>
          </div>
          <div>
        ...
        <div className="mt-8 border-t border-gray-200 pt-8 text-center">
          <p className="text-sm text-gray-600">&copy; 2023 Seoul Beautiful. All rights reserved.</p>
        </div>
      </div>
    </footer>
  )
